...
<div id="content">
  ...
  <div class="logo">
		<h1><a title="Feel Tighter" href="www.feeltighter.com"><span class="red">Feel Tighter</span></a></h1>
		<input type="image" src="/img/logo.png" width="95px" height="40px" class="button-sel" alt="www.feeltighter.com" title="www.feeltighter.com"/>
  </div>            

<div class="subheader" style="margin-left:20px">
    <h2>Log In</h2> to Feel Tighter
</div>
<div id="mainbar">
        ...
        <form id="sendToLog" name="sendToLog" method="post">            
            ...
            <div id="openid_choice" style="">
	            <p style="margin-right: 250px;">Your account. won´t be published. It has to be signed up previously by the system. Please click to <b>log in</b> with one of your accounts below:
                </p>
